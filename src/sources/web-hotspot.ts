...
export const DEFAULT_BOOST_TERMS = [
  'AI', '大模型', '模型', '芯片', '算法', '程序员', '代码', '开发', '技术', '互联网',
  '大厂', '字节', '腾讯', '阿里', '美团', '华为', '英伟达', 'OpenAI', 'Claude',
  '面试', '职场', '打工', '裁员', '晋升', '绩效', '简历', '应届', '求职', '副业', '内卷',
  '创业', '老板', '工资', '薪资', '收入', '股', '股价', '股市', '基金', '投资', '理财',
  '财富', '经济', '房价', '楼市', '比亚迪', '特斯拉', '新能源', '学历', '考研', '考公',
  '博士', '商业', '公司', '融资', '上市', '马斯克', '雷军', '王传福',
];
